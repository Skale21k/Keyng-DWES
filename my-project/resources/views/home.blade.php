                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="our-link">
                        <ul>
                            ...
                            <li><a href="#"><i class="fas fa-headset"></i> Contáctenos</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="login-box">
						<select id="basic" class="selectpicker show-tick form-control" data-placeholder="Sign In">
							<option>Registrate aquí!</option>
							<option>Inicia sesión</option>
						</select>
					</div>
                </div>
            </div>
        ...
        <ul class="slides-container">
            <li class="text-center">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Bienvenidos a <br> KEYNG</strong></h1>
                            <p class="m-b-40">Tu supermercado online de confianza<br> Envios en tan solo 2880 minutos</p>
                            <p><a class="btn hvr-hover" href="#">¡Compra ahora!</a></p>
                        </div>
                    </div>
                </div>
            </li>
