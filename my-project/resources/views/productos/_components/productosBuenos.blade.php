    ...
    <div class="product-item">
        <figure style="height:180px; width: 300px;">
            <a href="{{ route('productos.show', $producto) }}" title="{{ $producto->nombre }}">
                <img src="{{ $producto->imagen_url }}" alt="{{ $producto->nombre }}" class="tab-image" id="imagenProducto">
        ...
        <form action="{{ route('carrito.add') }}" method="post">
            ...
            <div class="d-flex align-items-center justify-content-between">
                <div class="input-group product-qty">
                    ...
                    <input type="text" id="cantidadInput" name="quantity[{{ $producto->id }}]" class="form-control input-number"
                        value="1" min="1">
                    <span class="input-group-btn">
